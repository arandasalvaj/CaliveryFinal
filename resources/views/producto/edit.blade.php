          ...
          <form action="{{route('producto.update',$product)}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row py-2">
                  <div class="col">
                      ...
                      <textarea class="form-control" rows="5" name="detail" type="text" placeholder="Ingrese Aqui el detalle para"></textarea>
                    </div>
              </div>
              <div class="row py-2">
                  <div class="col">
              ...
              <div class="row py-2">
                  <div class="col">
                      ...
                      <input type="file" name="img" accept="image/*" value="{{$product->img}}">
                      @error('file')
