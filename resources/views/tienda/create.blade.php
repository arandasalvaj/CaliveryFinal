...
@section('seccion')
@can('Seller')
<h1>Bienvenido, eres Vendedor y puedes crear tu tienda</h1>
             ...
             <div class="row">
              <div class="card-body">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationDefault02" name="addres" placeholder="Dirección" required>
                </div> 
                <div class="col-md-4 mb-3">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="email" class="form-control" id="validationDefault05" name="email" placeholder="Correo" required>
                </div>  
